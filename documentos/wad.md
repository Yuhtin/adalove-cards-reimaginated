...
Este documento descreve a aplicação AdaLove Reimagined, uma plataforma para gerenciar os seus cards da AdaLove de uma forma mais prática. O sistema permite que alunos do Inteli importem seus cartões de atividades e gerencie de uma forma mais simplificada.
...
O sistema foi desenvolvido utilizando Node.js com Express.js como framework web e PostgreSQL como banco de dados relacional.
